(() => {
    ...
    const state = { maxVisible: 5, animationDuration: 320, showProgress: true, pauseOnHover: true, queue: [], visible: new Map(), nextId: 1 };
    ...
    function enqueue(notification) {
        if (!notification || typeof notification.message !== 'string') return;
    ...
    window.addEventListener('message', ({ data }) => {
        ...
        if (data.action === 'configure') configure(data.config);
